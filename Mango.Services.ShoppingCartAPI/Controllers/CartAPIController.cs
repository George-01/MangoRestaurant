            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(checkoutHeader.CouponCode))
                {
                    ...
                    if (checkoutHeader.DiscountTotal != coupon.DiscountAmount)
                    {
                        ...
                        _response.DisplayMessages = "Coupon Price has changed, please confirm";
                        return _response;
                    }
                }
                ...
                // await _messageBus.PublishMesage(checkoutHeader, "checkoutqueue"); //checkoutmessagetopic you can either use a topic or a queue then forward to the topic
